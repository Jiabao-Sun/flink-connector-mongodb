...
@PublicEvolving
public class MongoReadOptionsBuilder {
    ...
    public MongoReadOptionsBuilder setCursorBatchSize(int cursorBatchSize) {
        checkArgument(
                cursorBatchSize >= 0, "The cursor batch size must be larger than or equal to 0.");
    ...
    public MongoReadOptionsBuilder setSamplesPerPartition(int samplesPerPartition) {
        checkArgument(samplesPerPartition > 0, "The samples per partition must be larger than 0.");
